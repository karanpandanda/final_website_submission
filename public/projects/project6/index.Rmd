...
This page looks at analysing a  dataset from IBM, to understand and explore some of the statistics present and gain some inferences through this. We proceed by cleaning the data, ensuring effective analysis. Subsequently, we will make note of the interesting results we see from the data!
